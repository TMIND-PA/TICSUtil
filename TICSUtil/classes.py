...
class TICSLogger:
    def __init__(self):
        ...
        max_filesize = os.environ['LOG_MAXSIZE'] if 'LOG_MAXSIZE' in os.environ else 5242880
        backupCount = os.environ['LOG_BACKUP_COUNT'] if 'LOG_BACKUP_COUNT' in os.environ else 10
